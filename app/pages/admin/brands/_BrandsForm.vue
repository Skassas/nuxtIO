<template>
  <form id="brand-form" @submit.prevent="$emit('submit', form)" class="space-y-4">
    ...
    <div>
      ...
      <input v-model="form.name" type="text" required minlength="2" placeholder="Marka adini girin"
    ...
    <div>
      ...
      <textarea v-model="form.description" rows="4" placeholder="Aciklama girin (istege bagli)"
