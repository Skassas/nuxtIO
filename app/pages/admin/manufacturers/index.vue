<template>
  <div>
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div class="flex-1 flex justify-center">
        <div class="relative w-full max-w-md">
          ...
          <input v-model="searchQuery" @keyup.enter="search" type="text" placeholder="Üretici ara..."
    ...
    <ManufacturersTable :manufacturers="items" :loading="loading" :current-page="currentPage" :total-pages="totalPages" :per-page="perPage" :total-items="totalItems"
    ...
    <AdminDrawer :isOpen="drawerOpen" :title="drawerTitle" :icon="drawerIcon" @close="closeDrawer">
      <ManufacturersView v-if="drawerMode === 'view'" :manufacturer="selectedItem" />
      <ManufacturersForm v-else v-model="form" :errors="formErrors" @submit="handleSubmit" />
      <template #footer>
        <div class="flex justify-end gap-3">
          ...
          <template v-else>
            <button type="submit" form="manufacturer-form" :disabled="saving"
...
import ManufacturersTable from './_ManufacturersTable.vue'
import ManufacturersForm from './_ManufacturersForm.vue'
import ManufacturersView from './_ManufacturersView.vue'
import type { Manufacturer } from './_ManufacturersTable.vue'
