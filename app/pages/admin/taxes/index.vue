<template>
  <div>
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div class="flex-1 flex justify-center">
        <div class="relative w-full max-w-md">
          ...
          <input v-model="searchQuery" @keyup.enter="search" type="text" placeholder="Vergi ara..."
    ...
    <TaxesTable :taxes="items" :loading="loading" :current-page="currentPage" :total-pages="totalPages" :per-page="perPage" :total-items="totalItems"
    ...
    <AdminDrawer :isOpen="drawerOpen" :title="drawerTitle" :icon="drawerIcon" @close="closeDrawer">
      <TaxesView v-if="drawerMode === 'view'" :tax="selectedItem" />
      <TaxesForm v-else v-model="form" :errors="formErrors" @submit="handleSubmit" />
      <template #footer>
        <div class="flex justify-end gap-3">
          ...
          <template v-else>
            <button type="submit" form="tax-form" :disabled="saving"
...
import TaxesTable from './_TaxesTable.vue'
import TaxesForm from './_TaxesForm.vue'
import TaxesView from './_TaxesView.vue'
import type { Tax } from './_TaxesTable.vue'
